...
const LiveTicker: React.FC = () => {
    const messages = [
        "🎉 Village Alpha just gained 500 points!",
        "🏆 New Weekly Champion: Musa from Village Beta!",
        "⚡ Village Gamma completed 50 lessons today!",
        "🌟 Amina earned the 'Speed Learner' badge!",
        "🔥 Village Delta is on a 7-day streak!",
        "💎 New record: 1000 lessons completed this week!",
    ];
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-brand-purple text-white py-3 shadow-2xl z-40 overflow-hidden">
            <div className="flex items-center gap-4 px-4">
                ...
                <div className="flex items-center gap-2 bg-white/20 px-3 py-1 rounded-full backdrop-blur-sm flex-shrink-0">
                    ...
                    <span className="font-black text-sm uppercase tracking-wider">Live</span>
                </div>
