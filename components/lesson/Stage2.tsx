...
const Stage2: React.FC<Stage2Props> = ({ onNext, onBack }) => {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-gradient-to-br from-brand-orange/10 to-brand-purple/10">
            <div className="max-w-3xl w-full bg-white dark:bg-zinc-900 rounded-3xl p-8 shadow-2xl">
                ...
                <h2 className="text-3xl font-black text-center text-brand-purple dark:text-white mb-6">
                    Learn the Concept
                </h2>
