    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-gradient-to-br from-brand-purple via-brand-orange to-brand-purple">
            <div className="max-w-2xl w-full bg-white bg-white rounded-3xl p-8 shadow-2xl">
                ...
                <h1 className="text-5xl font-black text-center text-brand-purple text-zinc-900 mb-4">
                    🎉 Leçon Terminée !
                </h1>

                <p className="text-2xl text-center text-zinc-600 text-zinc-600 mb-8">
                ...
                <div className="bg-gradient-to-br from-brand-purple/10 to-brand-orange/10 rounded-2xl p-8 mb-8">
                    ...
                    <p className="text-center text-lg font-bold text-zinc-700 text-zinc-700">
                        Votre Score
                    </p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 mb-8">
                    <div className="flex flex-col items-center p-4 bg-zinc-100 bg-zinc-100 rounded-xl">
