...
export default function ProfilePage() {
    return (
        <>
            ...
            <main className="min-h-screen bg-zinc-50 dark:bg-zinc-950 p-6 pb-24 md:pb-6">
                <div className="max-w-4xl mx-auto">
                        ...
                        <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-lg">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-zinc-600 dark:text-zinc-400">Lessons Completed</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-lg">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-zinc-600 dark:text-zinc-400">Badges Earned</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Achievements */}
                    <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-lg mb-8">
                        <h2 className="text-2xl font-black text-brand-purple dark:text-white mb-6">
                            Recent Achievements
                        </h2>
                    ...
                    <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 shadow-lg">
                        ...
                        <div className="space-y-4">
                            <button
                                className="w-full flex items-center justify-between p-4 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors min-h-[60px]"
                            ...
                            <button
                                className="w-full flex items-center justify-between p-4 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors min-h-[60px] text-red-600"
                                onClick={() => {
